...
Since the source code of the project contains the solutions to the exercises of the lecture, it is not published in this repository. Instead, the source code is available in a private repository at https://github.com/schlaich-group/machine-learning-interatomic-potentials. Get in touch if you want to use the lab course yourself get access to the solutions.